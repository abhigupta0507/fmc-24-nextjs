...
const CartItem = ({ item, updateQuantity, removeItem }) => (
  <div className="flex items-center justify-between p-4 border-b border-red-800">
    <div className="flex items-center space-x-4">
      <img
        src={`/api/placeholder/${item.image}`}
        alt={item.name}
    ...
    <div className="flex items-center space-x-2">
      <button
        ...
        className="p-1 rounded-full bg-red-800 hover:bg-red-700 text-white"
      >
        <Minus size={16} />
      </button>
      ...
      <button
        ...
        className="p-1 rounded-full bg-red-600 hover:bg-red-500 text-white"
      >
        <Trash2 size={16} />
      </button>
    </div>
...
const Cart = () => {
  const [cartItems, setCartItems] = useState([
    ...
    { id: 2, name: "Event Pass", price: 25.0, quantity: 1, image: "200/200" },
    {
      id: 3,
      name: "Food Coupon Book",
      price: 10.0,
      quantity: 3,
      image: "200/200",
    },
